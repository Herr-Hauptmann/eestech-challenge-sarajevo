        ...
        <div class="grid grid-cols-2 md:grid-cols-3 gap-8 my-12 px-3">
            <div class="border-2 border-gray-400 rounded-lg p-3">
                <div>
                  ...
                  <p class="inline-block pl-3 text-center font-bold">Application deadline</p>                
                </div>
                <div>
                    <p class="pt-3">
                        Applications close on 5th of March 2023, 23:59:59
                    </p>
                </div>
            </div>
            <div class="border-2 border-gray-400 rounded-lg p-3">
                <div>
                  ...
                  <p class="inline-block pl-3 text-center font-bold">Where?</p>                
                </div>
                <div>
                    <p class="pt-3">
                        Blum lab, Energoinvest
                    </p>
                    <p>
            ...
            <div class="border-2 border-gray-400 rounded-lg p-3">
                <div>
                  ...
                  <p class="inline-block pl-3 text-center font-bold">When?</p>                
                </div>
                <div>
                    <p class="pt-3">
                        10-12th of March, 2023
                    </p>
                </div>
            </div>
            <div class="border-2 border-gray-400 rounded-lg p-3">
                <div>
                  ...
                  <p class="inline-block pl-3 text-center font-bold">Participation fee</p>                
                </div>
                <div>
                    <p class="pt-3">
                        Absolutely free.
            ...
            <div class="border-2 border-gray-400 rounded-lg p-3 place-content-evenly">
                <div>
                    <div class="inline">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 inline">
                  ...
                  <p class="inline-block pl-3 text-center font-bold">Prizes</p>                
                </div>
                <div>
                    <p class="pt-3">
                        The winning team will win a free trip to the final round of the competition, along with many other valuable prizes.
                    </p>
                </div>
            </div>
            <div class="border-2 border-gray-400 rounded-lg p-3 place-content-evenly">
                <div>
                  ...
                  <p class="inline-block pl-3 text-center font-bold">Organization</p>                
                </div>
                <div>
                    <p class="pt-3">
                        EESTech Challenge Sarajevo has held two sucessfull editions of the Local round, with numerouse satisfied participants and partners.
                    </p>
                </div>
            </div>
        </div>
