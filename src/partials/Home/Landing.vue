    ...
    <div class="max-w-screen">
        <div class="grid md:grid-cols-2">
            ...
            <div class="roboto flex flex-col items-center justify-center">
                ...
                <a target="_blank" href="https://forms.gle/z8oGmxhTFN5JUT376" class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 shadow-lg shadow-blue-500/5 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 mt-4 lg:mt-24">Apply now!</a>
            </div>
        </div>
    </div>
</template>
